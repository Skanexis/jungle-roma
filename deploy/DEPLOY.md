...
В private chat бот сразу удаляет входящие сообщения пользователя, включая `/start`, `Tropico6` и пароль админки. Сообщения, которые отправляет сам бот, автоматически удаляются, если в чате нет активности 3 минуты.
